...
1. Перед фазой — прочитай `phase-XX-*-theory.md`.
2. Запроси наполнение: *«Напиши теорию для frontend Phase 3»*.
3. Backend-теория: [`../../todo-platform-backend/plans/guides/README.md`](../../todo-platform-backend/plans/guides/README.md)
...
|--------|----------|
| `full` | Полный гайд |
| `placeholder` | Структура, наполняется по запросу |

**Все frontend guides:** placeholder (наполняются по запросу).
...
| Фаза | Файл | Статус |
|------|------|--------|
| 0 | [phase-00-foundation-theory.md](./phase-00-foundation-theory.md) | placeholder |
| 1 | [phase-01-production-core-theory.md](./phase-01-production-core-theory.md) | placeholder |
| 2 | [phase-02-modern-angular-theory.md](./phase-02-modern-angular-theory.md) | placeholder |
| 3 | [phase-03-advanced-ngrx-theory.md](./phase-03-advanced-ngrx-theory.md) | placeholder |
| 4 | [phase-04-architecture-patterns-theory.md](./phase-04-architecture-patterns-theory.md) | placeholder |
| 5 | [phase-05-performance-theory.md](./phase-05-performance-theory.md) | placeholder |
| 6 | [phase-06-design-system-theory.md](./phase-06-design-system-theory.md) | placeholder |
...
[_template-phase-theory.md](./_template-phase-theory.md)
